                ...
                <table class="detailTable table" border="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
								<c:if test="${detailset.occupation==null||detailset.occupation==0}">
                                	<select name="task" id="user_task" class="form-select" disabled>
                                </c:if>
                                <c:if test="${detailset.occupation>0}">
                        ...
                        <tr>
                            <td class="td-file" colspan="3">
                                ...
                                <button type="button" class="btn btn-danger m-2" id="file-delete-btn${file.id}" onclick="fileDelete('${file.id}')">삭제</button>
                            </td>
                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="task" id="work_Task" class ="form-select work" disabled>
                                                <option class="workoccupation0" value="">직무 선택</option>
                                                <c:forEach var="task" items="${task}">
